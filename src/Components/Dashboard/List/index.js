...
function List({coin}) {
  return (
    <>
       <div>
           <div className='flex justify-around items-center w-full border border-blue-700'>
         ...
         <div className='flex justify-center items-center'>
            <div 
              className={`border-2 flex justify-center items-center gap-3 p-1
                    ml-4 w-40 rounded-xl hover:text-white ${
